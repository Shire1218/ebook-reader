...
function createMainWindow() {
  mainWindow = new electron.BrowserWindow(WINDOW_CONFIG);
...
function setupIpcHandlers() {
  ...
  electron.ipcMain.handle("fs:getFileInfo", async (_event, filePath) => {
    try {
  ...
  electron.ipcMain.handle("fs:saveFile", async (_event, filePath, content) => {
    try {
